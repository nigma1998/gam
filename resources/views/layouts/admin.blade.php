...
<head>
    ...
    <link href="{{ URL::asset('../public/css/owl.theme.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('../public/css/owl.transitions.css') }}" rel="stylesheet">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- meanmenu icon CSS
		============================================ -->
    <link href="{{ URL::asset('../public/css/meanmenu.min.css') }}" rel="stylesheet">
    <!-- main CSS
		============================================ -->
    ...
    <link href="{{ URL::asset('../public/css/metisMenu-vertical.css') }}" rel="stylesheet">
    <!-- calendar CSS
		============================================ -->
    <link href="{{ URL::asset('../public/css/fullcalendar.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('../public/css/fullcalendar.print.min.css') }}" rel="stylesheet">
    <!-- style CSS
		============================================ -->
    ...
    <link href="{{ URL::asset('../public/js/vendor/modernizr-2.8.3.min.js') }}" rel="stylesheet">
    <!-- modernizr JS
		============================================ -->
